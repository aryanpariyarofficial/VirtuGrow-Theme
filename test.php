                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-lg-center menu__inner flex-grow-1">
                            ...
                            <li class="menu__inner--item d-none d-lg-block">
                                <a href="/wat-doen-wij" class="menu__inner--item--link">
                                    ...
                                    <ul class="submenu__list">
                                        <li class="item">
                                            <a href="/ai-mogelijkheden">
                                                Ai Mogelijkheden
                                                <span>Onze AI-mogelijkheden helpen bedrijven efficiënter werken en
                                                    slimmer groeien met behulp van geavanceerde technologie.</span>
                                            </a>
                                        </li>
                                        <li class="item">
                                            <a href="/ai-klantenservice">
                                                AI Klantenservice
                                                <span>Met AI-klantenservice bieden we snelle, nauwkeurige en 24/7
                                                    ondersteuning om de klanttevredenheid te verbeteren.</span>
                                            </a>
                                        </li>
                                        <li class="item">
                                            <a href="/ai-leadgenerator">
                                                AI Leadgenerator
                                                <span>Onze AI-gedreven leadgenerator identificeert potentiële klanten
                                                    automatisch, zodat uw verkoopteam zich kan richten op
                                                    conversie.</span>
                                            </a>
                                        </li>
                                        <li class="item">
                                            <a href="/ai-afsprakenmanager">
                                                AI Afsprakenmanager
                                                <span>De AI-afsprakenmanager plant en beheert automatisch
                                                    klantafspraken, waardoor uw team tijd bespaart en niets over het
                                                    hoofd ziet.</span>
                                            </a>
                                        </li>
                                        <li class="item">
                                            <a href="/ai-reputatie-manager">
                                                ...
                                                <span>Met de AI-reputatiemanager bewaakt en verbetert u uw online
                                                    reputatie op basis van realtime analyses en inzichten.</span>
                                            </a>
                                        </li>
                                        <li class="item">
                                            <a href="/ai-automatiseringen">
                                                AI Automatiseringen
                                                <span>Wij helpen u processen automatiseren met AI, zodat uw bedrijf
                                                    sneller, consistenter en foutloos opereert.</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <ul class="accordion-item-ul">
                                                <li class="">
                                                    <a class="nav-link" href="/ai-mogelijkheden">Ai Mogelijkheden</a>
                                                </li>
                                                <li class="">
                                                    <a class="nav-link" href="/ai-klantenservice">AI Klantenservice</a>
                                                </li>
                                                <li class="">
                                                    <a class="nav-link" href="/ai-leadgenerator">AI Leadgenerator</a>
                                                </li>
                                                <li class="">
                                                    <a class="nav-link" href="/ai-afsprakenmanager">AI
                                                        Afsprakenmanager</a>
                                                </li>
                                                <li class="">
                                                    <a class="nav-link" href="/ai-reputatie-manager">AI Reputatie
                                                        Manager</a>
                                                </li>
                                                <li class="">
                                                    <a class="nav-link" href="/ai-automatiseringen">AI
                                                        Automatiseringen</a>
                                                </li>
                                            </ul>
                                        </div>
